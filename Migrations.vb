...
Public Class frmMigration_COA

#Disable Warning CA1051 ' Do not declare visible instance fields
#Disable Warning CA2000 ' Do not declare visible instance fields
...
#Disable Warning CA1062 ' Do not declare visible instance fields
#Disable Warning CA1303 ' Do not declare visible instance fields

    Private ReadOnly FilePath As String = "E:\AMCORP-ORIENT\Data Upload\"
    Private ReadOnly FileName As String = "Recommanded Chart of Accounts.xlsx"
    ...
    Private Property SourceCompanyID As Integer = 6          ' Select Amcor-Orient JV Company
    ...
    Private Sub Migration_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub MyRefresh()
        ...
        '        Table_ItemCat = Get_DataTable(TableNameItemCOA, Connection_Amcorp)
